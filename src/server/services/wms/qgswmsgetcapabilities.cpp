...
namespace QgsWms
{
                                 ...
                                 const QgsWmsRequest &request, const QgsServerSettings *serverSettings )
  {
    ...
    if ( onlineResource.isEmpty() )
    {
      ...
      QgsMessageLog::logMessage( QStringLiteral( "wmsgetcapabilities 4b Service URL %1" ).arg( onlineResource ), "wmsgetcapabilities" );
      QgsMessageLog::logMessage( QStringLiteral( "wmsgetcapabilities 4b Service URL %2" ).arg( onlineResource ), QStringLiteral( "Server" ) );
    }
